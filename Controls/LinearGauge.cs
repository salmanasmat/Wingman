...
namespace Wingman.Controls
{
    public class LinearGauge : FrameworkElement
    {
        ...
        protected override void OnRender(DrawingContext dc)
        {
            ...
            var borderPen = new Pen(new SolidColorBrush(Color.FromRgb(226, 232, 240)), 1);
            dc.DrawRoundedRectangle(trackBrush, borderPen, new Rect(0, 0, w, h), 4, 4);
            ...
            if (fillWidth > 0)
            {
                dc.DrawRoundedRectangle(BarColor, null, new Rect(0, 0, fillWidth, h), 4, 4);
            }

            // Label Text
            Brush textBrush = pct > 60 ? Brushes.White : new SolidColorBrush(Color.FromRgb(30, 41, 59));
